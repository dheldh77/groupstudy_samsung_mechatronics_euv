...
![Screen Shot 2022-04-17 at 4.13.34 PM.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/53dbacb0-edd6-4606-a2eb-f9fb1a59a93f/Screen_Shot_2022-04-17_at_4.13.34_PM.png)
...
![Screen Shot 2022-04-17 at 4.18.43 PM.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/5b4ec11f-e177-4015-bd84-ff9e55ffc912/Screen_Shot_2022-04-17_at_4.18.43_PM.png)
...
![Screen Shot 2022-04-17 at 4.31.26 PM.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/dfdad423-da01-46b5-8f23-75ff428ba412/Screen_Shot_2022-04-17_at_4.31.26_PM.png)
...
![Screen Shot 2022-04-17 at 4.37.20 PM.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/53017bb8-6c1c-405f-8ab6-732b8ee8afd3/Screen_Shot_2022-04-17_at_4.37.20_PM.png)

![Screen Shot 2022-04-17 at 4.37.41 PM.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/8ebb5905-bee2-4f32-95a8-3e125931b1c9/Screen_Shot_2022-04-17_at_4.37.41_PM.png)
...
> [ProfileController.java] 링크
> 
- env.getActiveProfiles()
    - 현재 실행 중인 ActiveProfile을 모두 가져옴

> [ProfileController.java 테스트 코드] 링크
> 
...
> [application-real1.yml] 링크
> 
- port : 8081

> [application-real2.yml] 링크
> 
- port: 8082
...
- 무중단 배포를 진행할 스크립트를 사용하도록 설정
    - [stop.sh](http://stop.sh) : 기존 엔진엑스에 연결되어 있진 않지만, 실행 중이던 스프링 부트 종료
    - [start.sh](http://start.sh) : 배포할 신규 버전 스프링 부트 프로젝트를 stop.sh로 종료한 ‘profile’로 실행
    - [health.sh](http://health.sh) : ‘start.sh’로 실행시킨 프로젝트가 정상적으로 실행됐는지 체크
    - [switch.sh](http://switch.sh) : Nginx가 바라보는 스프링 부트를 최신 버전으로 변경
    - [profile.sh](http://profile.sh) : 앞선 4개 스크립트 파일에서 공용으로 사용할 ‘profile’과 포트 체크 로직
- Jar 파일이 복사된 이후부터 차례로 스크립트들이 실행

> [profile.sh] 링크
> 
- $(curl -s -o /dev/null -w “%{http_code}” [http://localhost/profile)](http://localhost/profile)-)
